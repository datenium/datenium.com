...
const PeopleCard: React.FC<PeopleCardProps> = ({ name, role, imageUrl }) => (
  <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
    ...
    <div className="flex mt-3 -mx-2">
      <a
        href="#"
        className="mx-2 text-gray-900  hover:text-gray-900 group-hover:text-white"
        aria-label="Github"
      >
...
const TeamPage = () => {
  return (
    ...
    <div className="container px-6 py-10 mx-auto">
      <h1 className="text-3xl font-semibold text-center text-gray-600  capitalize lg:text-4xl">Our Team</h1>

      <p className="max-w-2xl mx-auto my-6 text-center text-gray-900 ">
      We are a skilled team in AI and Full Stack Development, creating smart solutions that make businesses stand out. 
     We are continuously expanding our teams, welcoming new talents to fuel our ongoing growth and enhance our collective capabilities.
      </p>
